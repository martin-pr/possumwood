...
void init(possumwood::Metadata& meta) {
	meta.addAttribute(a_inFrame, "in_frame", anim::Skeleton(), possumwood::Metadata::Flags::kVertical);
	...
	meta.addAttribute(a_outFrame, "out_frame", anim::Skeleton(), possumwood::Metadata::Flags::kVertical);
