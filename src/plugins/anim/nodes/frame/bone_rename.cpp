...
void init(possumwood::Metadata& meta) {
	meta.addAttribute(a_inSkeleton, "in_skeleton", anim::Skeleton(), possumwood::Metadata::Flags::kVertical);
	meta.addAttribute(a_regex, "regex", std::string(".*"));
	meta.addAttribute(a_outSkeleton, "out_skeleton", anim::Skeleton(), possumwood::Metadata::Flags::kVertical);
