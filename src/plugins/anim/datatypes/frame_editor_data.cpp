...
void toJson(::dependency_graph::io::json& json, const anim::FrameEditorData& value) {
	for(auto& i : value) {
...
void fromJson(const ::dependency_graph::io::json& json, anim::FrameEditorData& value) {
	value.clear();
