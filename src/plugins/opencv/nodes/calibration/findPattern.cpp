...
dependency_graph::InAttr<possumwood::opencv::CirclesGrid> a_inPattern;
dependency_graph::InAttr<bool> a_clustering;
dependency_graph::OutAttr<possumwood::opencv::CirclesGrid> a_outPattern;

dependency_graph::State compute(dependency_graph::Values& data) {
	const possumwood::opencv::CirclesGrid& inPattern = data.get(a_inPattern);
	...
	if(inPattern.type() == possumwood::opencv::CirclesGrid::kSymmetricGrid)
	...
	const possumwood::opencv::CirclesGrid grid(result, inPattern.size(), success, inPattern.type());
...
void init(possumwood::Metadata& meta) {
	...
	meta.addAttribute(a_inPattern, "in_pattern", possumwood::opencv::CirclesGrid(), possumwood::AttrFlags::kVertical);
	meta.addAttribute(a_clustering, "clustering");
	meta.addAttribute(a_outPattern, "out_pattern", possumwood::opencv::CirclesGrid(), possumwood::AttrFlags::kVertical);
