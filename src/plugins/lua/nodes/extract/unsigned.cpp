...
dependency_graph::OutAttr<unsigned> a_out;
...
dependency_graph::State compute(dependency_graph::Values& data) {
	...
	try {
		// get the result
		unsigned value = luabind::object_cast<unsigned>(state->globals()[data.get(a_name)]);
...
possumwood::NodeImplementation s_impl("lua/extract/unsigned", init);
